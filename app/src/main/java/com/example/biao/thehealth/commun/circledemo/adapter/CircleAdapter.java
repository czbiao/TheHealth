package com.example.biao.thehealth.commun.circledemo.adapter;
...
import com.example.biao.thehealth.BottomNvgViewPageAct;
import com.example.biao.thehealth.commun.CommunFragment;
import com.example.biao.thehealth.commun.circledemo.MyApplication;
import com.example.biao.thehealth.R;
import com.example.biao.thehealth.commun.circledemo.activity.ImagePagerActivity;
import com.example.biao.thehealth.commun.circledemo.activity.MainActivity;
import com.example.biao.thehealth.commun.circledemo.adapter.viewholder.CircleViewHolder;
import com.example.biao.thehealth.commun.circledemo.adapter.viewholder.ImageViewHolder;
import com.example.biao.thehealth.commun.circledemo.adapter.viewholder.URLViewHolder;
import com.example.biao.thehealth.commun.circledemo.adapter.viewholder.VideoViewHolder;
import com.example.biao.thehealth.commun.circledemo.bean.ActionItem;
import com.example.biao.thehealth.commun.circledemo.bean.CircleItem;
import com.example.biao.thehealth.commun.circledemo.bean.CommentConfig;
import com.example.biao.thehealth.commun.circledemo.bean.CommentItem;
import com.example.biao.thehealth.commun.circledemo.bean.FavortItem;
import com.example.biao.thehealth.commun.circledemo.bean.PhotoInfo;
import com.example.biao.thehealth.commun.circledemo.mvp.presenter.CirclePresenter;
import com.example.biao.thehealth.commun.circledemo.utils.DatasUtil;
import com.example.biao.thehealth.commun.circledemo.utils.GlideCircleTransform;
import com.example.biao.thehealth.commun.circledemo.utils.UrlUtils;
import com.example.biao.thehealth.commun.circledemo.widgets.CircleVideoView;
import com.example.biao.thehealth.commun.circledemo.widgets.CommentListView;
import com.example.biao.thehealth.commun.circledemo.widgets.ExpandTextView;
import com.example.biao.thehealth.commun.circledemo.widgets.MultiImageView;
import com.example.biao.thehealth.commun.circledemo.widgets.PraiseListView;
import com.example.biao.thehealth.commun.circledemo.widgets.SnsPopupWindow;
import com.example.biao.thehealth.commun.circledemo.widgets.dialog.CommentDialog;
                        ...
                        if (photos != null && photos.size() > 0) {
                            ...
                            ((ImageViewHolder)holder).multiImageView.setOnItemClickListener(new MultiImageView.OnItemClickListener() {
                                ...
                                public void onItemClick(View view, int position) {
                                    ...
                                    ImagePagerActivity.startImagePagerActivity(((BottomNvgViewPageAct) context), photoUrls, position, imageSize);
