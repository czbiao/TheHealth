package com.example.biao.thehealth.commun;
...
import com.example.biao.thehealth.commun.circledemo.mvp.contract.CircleContract;
import com.example.biao.thehealth.commun.circledemo.mvp.presenter.CirclePresenter;
import com.example.biao.thehealth.commun.circledemo.utils.CommonUtils;
import com.example.biao.thehealth.commun.circledemo.utils.SystemBarUtil;
import com.example.biao.thehealth.commun.circledemo.widgets.CommentListView;
import com.example.biao.thehealth.commun.circledemo.widgets.DivItemDecoration;
import com.example.biao.thehealth.commun.circledemo.widgets.dialog.UpLoadDialog;
 ...
 */
public class CommunFragment extends Fragment implements CircleContract.View, EasyPermissions.PermissionCallbacks {

    protected static final String TAG = com.example.biao.thehealth.commun.circledemo.activity.MainActivity.class.getSimpleName();
    ...
    private void initView() {
        ...
        recyclerView = (SuperRecyclerView) view_i.findViewById(R.id.recyclerView);
        ...
        recyclerView.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if(newState == RecyclerView.SCROLL_STATE_IDLE){
                    Glide.with(com.example.biao.thehealth.commun.CommunFragment.this).resumeRequests();
                }else{
                    Glide.with(com.example.biao.thehealth.commun.CommunFragment.this).pauseRequests();
                }
        ...
        edittextbody = (LinearLayout) view_i.findViewById(R.id.editTextBodyLl);
        editText = (EditText) view_i.findViewById(R.id.circleEt);
        sendIv = (ImageView) view_i.findViewById(R.id.sendIv);
    ...
    private void setViewTreeObserver() {
        bodyLayout = (RelativeLayout) view_i.findViewById(R.id.bodyLayout);
